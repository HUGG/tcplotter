...
def main():
    ...
    parser.add_argument('--plot-style', dest='plot_style', help='Style sheet used for plotting. See https://matplotlib.org/stable/gallery/style_sheets/style_sheets_reference.html.', default='seaborn-colorblind',
                        type=str)
    parser.add_argument('--plot-colormap', dest='plot_colormap',
                        help='Colormap used for plotting. See https://matplotlib.org/stable/tutorials/colors/colormaps.html.', default='plasma',
                        type=str)
    parser.add_argument('--plot-alpha', dest='plot_alpha', help='Transparency used for plotting fill colors', default=1.0,
                        type=float)
    parser.add_argument('--plot-contour-lines', dest='plot_contour_lines', help='Number of contour lines used for plotting', default=12,
                        type=int)
    parser.add_argument('--plot-contour-fills', dest='plot_contour_fills', help='Number of contour fill colors from the selected colormap', default=256,
                        type=int)
