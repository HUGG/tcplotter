...
def main():
    ...
    parser.add_argument('--no-clean-up-files', dest='no_clean_up_files', help='Do not delete temporary files',
                        action='store_true', default=False)
    ...
    rate_vs_age_tc(num_points=args.num_points, rate_min=args.rate_min, rate_max=args.rate_max, temp_max=args.temp_max,
                   ...
                   plot_age_min=args.plot_age_min, plot_age_max=args.plot_age_max, plot_tc_min=args.plot_tc_min,
                   plot_tc_max=args.plot_tc_max, save_plot=args.save_plot, plot_file_format=args.plot_file_format,
                   display_plot=display_plot, clean_up_files=clean_up_files, verbose=args.verbose, use_widget=False)
